		...
		<div class="row">
			<div class="medium-12 columns">
				...
				<div class="right">
					...
					<a href="{!! url('/account') !!}"><span class="hide-for-small">{{ Auth::user()->username }}</span><span class="show-for-small"><i class="ion-person"></i></span> <span class="header-rep-count">{{ Auth::user()->level() }} ({{ Auth::user()->rep() }} rep)</span></a>
